      ...
      <div className="stats-grid">
        <div className="stat-card">
          <div className="stat-icon level">
            <span className="level-number">{userStats?.gamification?.currentLevel || 1}</span>
          </div>
          <div className="stat-content">
            <h3>Level {userStats?.gamification?.currentLevel || 1}</h3>
            <p>Reading Level</p>
          </div>
        </div>
        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            <h3>{(userStats?.gamification?.totalPoints || 0).toLocaleString()}</h3>
            <p>Total Points</p>
          </div>
        </div>
        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            <h3>{userStats?.gamification?.achievementsEarned || 0}</h3>
            <p>Achievements</p>
          </div>
        </div>
        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            <h3>{userStats?.reading?.booksRead || 0}</h3>
            <p>Books Read</p>
          </div>
        </div>
      </div>
        ...
        <div className="progress-cards">
          <div className="progress-card">
            ...
            <div className="progress-value">
              {userStats?.reading?.readingStreak?.current || 0} days
            </div>
            <div className="progress-subtitle">
              Longest: {userStats?.reading?.readingStreak?.longest || 0} days
            </div>
          </div>
          ...
          <div className="progress-card">
            ...
            <div className="progress-value">
              {userStats?.community?.clubsJoined || 0}
            </div>
            <div className="progress-subtitle">
              Active memberships
            </div>
